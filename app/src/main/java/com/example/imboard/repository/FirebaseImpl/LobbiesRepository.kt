...
interface LobbiesRepository {
    suspend fun addLobby(lobbyName: String, lobbyImage :Int, location : String , host: User, game: Game ,lobbyMaxPlayers : Int, date: String, time:String, haveTheGame : Boolean) : Resource<Void>
